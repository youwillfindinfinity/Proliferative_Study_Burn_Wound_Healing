...
filename = "S1_all_vars1.pickle" # change to name according to sobol key
...
plt.title('Sobol Indices Heatmap for Scenario 1') # Change title according to scenario
plt.xlabel('Parameters')
plt.ylabel('Samples')
plt.savefig("S1_sc1", dpi = 400) # change filename according to scenario
plt.show()