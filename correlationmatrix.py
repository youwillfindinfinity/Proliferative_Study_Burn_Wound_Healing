...
simulated_data_df = pd.DataFrame({
    ...
    'CIII2': CIII2[1:],
    'CI2': CI2[1:]
}, index = list(simulated_data_df.keys()))

# Print the correlation matrix
print(simulated_data_df)
# Calculate the correlation matrix between parameters and simulated values
correlation_matrix = params_df.transpose().corrwith(simulated_data_df)
